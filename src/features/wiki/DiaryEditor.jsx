...
export default function DiaryEditor({ open, diaryDate, onClose }) {
    ...
    const dialog = (
        ...
        >
            <div
                className="ui-dialog flex max-h-[88vh] min-h-[76vh] w-full flex-col overflow-hidden rounded-t-2xl p-3 sm:max-h-[92vh] sm:min-h-[82vh] sm:w-[min(760px,calc(100vw-32px))] sm:rounded-2xl sm:p-4"
